...
function sentiment(text) {
  const negativeSentiments = text.toLowerCase().match(negativeRegex) || [];
  const negativeWordCount = negativeSentiments.length;

  const positiveSentiments = text.toLowerCase().match(positiveRegex) || [];
  const positiveWordCount = positiveSentiments.length;
