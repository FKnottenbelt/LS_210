...
function wantToVisit(museum, city) {
  // since this is not the time to be clever:
  if (museum.includes('Computer')) return true;
  if (museum.includes('Science')) return true;
  if (museum.includes('Modern')
      && museum.includes('Art')
      && (museum.includes('Andy Warhol'))) return true;
  if (museum.includes('Modern')
      && museum.includes('Art')
      && city === 'Amsterdam') return true;
